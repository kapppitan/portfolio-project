                ...
                <div className='w-full h-content bg-[#fbf5e7] rounded-2xl border-4 border-[#30322d] overflow-hidden shadow-lg items-center'>
                    ...
                    <div className="border-b-4 border-t-4 p-5 gap-5 flex flex-col">
                        <div className="flex gap-2 w-full">
                            <div className="border-4 rounded-lg px-5 py-2 text-md lg:px-5 lg:text-2xl flex w-full items-center gap-5 hover:bg-white">
                                <img className="h-3 lg:h-5" src="search.png" alt="search" />
                                Search
                            </div>

                            <img className="hidden lg:flex border-4 rounded-lg h-8 lg:h-15 p-2 lg:p-3 hover:bg-white" src="filter.png" alt="filter" />
                        </div>

                        <div className="flex gap-2 text-xs lg:text-lg items-center flex-wrap lg:flex-row">
                    ...
                    <div className='flex flex-col'>
                        <div className="border-b-4 p-5 lg:p-15 flex gap-10 w-full flex-col lg:flex-row items-center lg:items-stretch">
                            <img className="border-4 rounded-xl h-50 w-50 lg:w-fit lg:h-content" src="travelers.png" />
                            <div className="flex flex-col gap-0 lg:gap-5 text-center lg:text-start">
                                <div className="gap-2 flex flex-col">
                                    <h1 className="text-3xl lg:text-6xl">The Travelers { '(A Blog)' }</h1>
                                    <p className="text-2xl text-neutral-500">By Raphy J. Ibrahim</p>
                                </div>

                                <div className="text-2xl text-justify px-0 py-5 lg:px-0">
                                    A blogging website dedicated to BSIT Industry Tour 2025. It contains our journey from day 1 to day 8 of the tour to Luzon.
                                </div>

                                <div className="flex w-full items-center gap-1 lg:gap-5 mt-auto">
                        ...
                        <div className="border-b-4 p-5 lg:p-15 flex gap-10 w-full flex-col lg:flex-row items-center lg:items-stretch">
                            <img className="border-4 rounded-xl h-50 w-50 lg:w-fit lg:h-content bg-cover" src="calculator.jpeg" />
                            <div className="flex flex-col gap-0 lg:gap-5 text-center lg:text-start">
                                <div className="gap-2 flex flex-col">
                                    <h1 className="text-3xl lg:text-6xl">A Cute Calculator</h1>
                                    <p className="text-2xl text-neutral-500">By Raphy J. Ibrahim</p>
                                </div>
                        ...
                        <div className="p-5 lg:p-15 flex gap-10 w-full flex-col lg:flex-row items-center lg:items-stretch">
                            <img className="border-4 rounded-xl h-50 w-50 lg:w-fit lg:h-content bg-cover" src="therental.jpeg" />
                            <div className="flex flex-col gap-0 lg:gap-5 text-center lg:text-start">
                                <div className="gap-2 flex flex-col">
                                    <h1 className="text-3xl lg:text-6xl">The Rental Store</h1>
                                    <p className="text-2xl text-neutral-500">By Raphy J. Ibrahim</p>
                                </div>
