    ...
    return (
        <div className='flex h-screen' id='hero'>
            ...
            <div className='absolute flex lg:flex-col p-5 lg:p-20 gap-5 lg:gap-20 w-full items-center lg:items-start justify-center pt-15'>
                <a className='w-15 lg:w-25 outline-0 cursor-default text-center hover:bg-[#fbf5e7] rounded-lg p-2' href='#about-me'>
                    <img src="old-computer.png" alt="image" />
                    About
                </a>

                <a className='w-15 lg:w-25 outline-0 cursor-default text-center hover:bg-[#fbf5e7] rounded-lg p-2' href="#projects">
                    <img src="open-folder.png" alt="image" />
                    <p className='font-medium'>Projects</p>
                </a>

                <a className='w-15 lg:w-25 outline-0 cursor-default text-center hover:bg-[#fbf5e7] rounded-lg p-2' href="#">
            ...
            <div className='flex flex-col w-screen items-center justify-center overflow-hidden'>
                <div className='w-70 lg:w-1/2 h-content bg-[#fbf5e7] rounded-2xl border-4 border-[#30322d] overflow-hidden shadow-lg'>
                    <div className='p-2.5 bg-[#c3e7e5] flex justify-between items-center'>
                        <p className='flex-grow text-center text-1xl lg:text-3xl'>The Raphysitory</p>
                        <button className='w-8 rounded-[100%] bg-red-400 flex justify-center items-center border-4'>‎</button>
                    </div>
